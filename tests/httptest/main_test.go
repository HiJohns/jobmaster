...
func setupTestDB() bool {
	...
	if os.Getenv("FORCE_RESEED") == "true" {
		...
		// Also clear demo tenant data
		testDB.Exec("DELETE FROM workorders WHERE tenant_id = 'd0000000-0000-0000-0000-000000000001'")
		testDB.Exec("DELETE FROM users WHERE tenant_id = 'd0000000-0000-0000-0000-000000000001'")
		testDB.Exec("DELETE FROM organizations WHERE tenant_id = 'd0000000-0000-0000-0000-000000000001'")
		testDB.Exec("DELETE FROM tenants WHERE uuid = 'd0000000-0000-0000-0000-000000000001'")
	}
	...
	testDB.Exec("ALTER TABLE organizations ADD COLUMN IF NOT EXISTS province_code VARCHAR(20)")
	testDB.Exec("ALTER TABLE organizations ADD COLUMN IF NOT EXISTS city_code VARCHAR(20)")
	testDB.Exec("ALTER TABLE organizations ADD COLUMN IF NOT EXISTS district_code VARCHAR(20)")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS division_id UUID")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS owner_org_id UUID")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS engineer_id UUID")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS handler_id UUID")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS parent_provider_id UUID")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS hop_limit INT DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS current_hop INT DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS dispatch_path JSONB DEFAULT '[]'::jsonb")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS scheduled_at TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS arrived_at TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS started_at TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS finished_at TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS closed_at TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS appointed_at TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS observing_deadline TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS settlement_amount DECIMAL")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS settlement_note VARCHAR(500)")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS labor_fee DECIMAL DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS material_fee DECIMAL DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS other_fee DECIMAL DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS priority INT DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS sla_deadline TIMESTAMP")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS priority_fee DECIMAL DEFAULT 0")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS address_detail VARCHAR(500)")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS coordinates JSONB")
	testDB.Exec("ALTER TABLE workorders ADD COLUMN IF NOT EXISTS appointment_type INT DEFAULT 1")
	testDB.Exec("CREATE TABLE IF NOT EXISTS escalation_records (id UUID PRIMARY KEY, order_id UUID, notified_at TIMESTAMP, recipient VARCHAR(255), message TEXT, created_at TIMESTAMP)")
